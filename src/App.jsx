        ...
        >
            ...
            <div className="flex-grow">
                {isDashboard ? (
                    ...
                    <div className="flex items-center justify-center min-h-full py-10 px-4 sm:px-6">
                        <div
                            className={`w-[90%] sm:w-full sm:max-w-md
                                shadow-lg rounded-2xl p-8 transition-colors duration-300 ${
                                    darkMode
                                        ? "bg-gray-800 text-gray-100"
